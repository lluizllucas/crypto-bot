...
Usado pelo backtest e pelo bot ao vivo via market_data_service.
"""
...
def add_indicators(df: pd.DataFrame) -> pd.DataFrame:
    ...
    plus_di14 = 100 * \
        plus_dm.rolling(14).mean() / atr14.replace(0, float("nan"))
    minus_di14 = 100 * \
        minus_dm.rolling(14).mean() / atr14.replace(0, float("nan"))
